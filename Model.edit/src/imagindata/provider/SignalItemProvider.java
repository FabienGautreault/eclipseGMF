...
/**
 * This is the item provider adapter for a {@link imagindata.Signal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 imagindataPackage.Literals.SIGNAL__NAME,
				 true,
				 false,
				 false,
	...
	protected void addObjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_object_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_object_feature", "_UI_Signal_type"),
				 imagindataPackage.Literals.SIGNAL__OBJECT,
				 true,
				 false,
				 true,
				 null,
