...
/**
 * This is the item provider adapter for a {@link imagindata.Object} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Object_Signal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Object_Signal_feature", "_UI_Object_type"),
				 null,
				 true,
				 false,
				 true,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 imagindataPackage.Literals.OBJECT__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((imagindata.Object)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(imagindata.Object.class)) {
