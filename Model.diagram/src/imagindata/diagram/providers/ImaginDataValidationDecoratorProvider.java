...
import imagindata.diagram.part.ValidationMarker;
 ...
 * @generated
 */
public class ImaginDataValidationDecoratorProvider extends AbstractProvider
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ImaginDataDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& DiagramEditPart.MODEL_ID.equals(ImaginDataVisualIDRegistry
						.getModelID(view));
	}
