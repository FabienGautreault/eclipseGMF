 ...
 * @generated
 */
public class CloneDiagram3006Command extends CommandWrapper {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public CloneDiagram3006Command(View parentView, Node childNode,
	...
	private Command createAfterCopyCommand() {
		...
		result.append(new CreateNotationalNodeCommand(parentView, copyResult,
				constraint, DiagramViewFactory.INSTANCE));
		return result;
	}
