...
public class TransitionCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof StateObject) {
			return false;
		}
		if (target != null && false == target instanceof StateObject) {
			return false;
		}
		if (getSource() == null) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Transition newElement = imagindata.imagindataFactory.eINSTANCE
				.createTransition();
		getContainer().getTransitions().add(newElement);
		newElement.setStart(getSource());
		newElement.setEnd(getTarget());
		ImaginDataElementTypes.init_Transition_4001(newElement);
	 ...
	 * @generated
	 */
	protected StateObject getSource() {
		return (StateObject) source;
	}

	/**
	 * @generated
	 */
	protected StateObject getTarget() {
		return (StateObject) target;
	}
