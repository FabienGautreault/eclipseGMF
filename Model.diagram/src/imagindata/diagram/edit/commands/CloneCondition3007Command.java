 ...
 * @generated
 */
public class CloneCondition3007Command extends CommandWrapper {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public CloneCondition3007Command(View parentView, Node childNode,
	...
	private Command createAfterCopyCommand() {
		...
		result.append(new CreateNotationalNodeCommand(parentView, copyResult,
				constraint, ConditionViewFactory.INSTANCE));
		return result;
	}
