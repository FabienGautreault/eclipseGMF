 ...
 * @generated
 */
public class CloneInitExit3005Command extends CommandWrapper {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public CloneInitExit3005Command(View parentView, Node childNode,
	...
	private Command createAfterCopyCommand() {
		...
		result.append(new CreateNotationalNodeCommand(parentView, copyResult,
				constraint, InitExitViewFactory.INSTANCE));
		return result;
	}
