 ...
 * @generated
 */
public class CloneRegion2007Command extends CommandWrapper {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public CloneRegion2007Command(View parentView, Node childNode,
	...
	private Command createAfterCopyCommand() {
		...
		result.append(AddCommand.create(editingDomain, parentView.getElement(),
				imagindata.imagindataPackage.eINSTANCE.getDiagram_Regions(),
				copyResult));
		if (constraint != null) {
		...
		result.append(new CreateNotationalNodeCommand(parentView, copyResult,
				constraint, RegionViewFactory.INSTANCE));
		return result;
	}
