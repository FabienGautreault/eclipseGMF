...
import imagindata.diagram.edit.helpers.ImaginDataBaseEditHelper;
 ...
 * @generated
 */
public class ImaginDataBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected ImaginDataBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(ImaginDataVisualIDRegistry
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request.setParameter(ImaginDataBaseEditHelper.EDIT_POLICY_COMMAND,
					command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(ImaginDataBaseEditHelper.CONTEXT_ELEMENT_TYPE,
				requestContextElementType);
		ICommand command = requestContextElementType.getEditCommand(request);
		request
				.setParameter(ImaginDataBaseEditHelper.EDIT_POLICY_COMMAND,
						null);
		request.setParameter(ImaginDataBaseEditHelper.CONTEXT_ELEMENT_TYPE,
				null);
		if (command != null) {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = ImaginDataElementTypes
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateTransition_4001(Region container,
				StateObject source, StateObject target) {
		 ...
		 * @generated
		 */
		public static boolean canExistTransition_4001(Region container,
				StateObject source, StateObject target) {
			try {
				if (source == null) {
					return true;
