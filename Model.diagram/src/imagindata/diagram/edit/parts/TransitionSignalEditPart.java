...
import org.eclipse.gmf.runtime.lite.edit.parts.labels.BaseLinkLabelEditPart;
 ...
 * @generated
 */
public class TransitionSignalEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ImaginDataVisualIDRegistry
						.getType(imagindata.diagram.edit.parts.TransitionSignalEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public TransitionSignalEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ImaginDataTextSelectionEditPolicy());
	...
	protected String getLabelText() {
		...
		if (parserElement != null && getParser() != null) {
			...
			//Si on a édité
			if (!text.equals("Signal")) {
				isEdited = true;
			}
		}
		//Mais si on édite et que l'on ne met rien on ne l'affiche plus
		if (text.length() == 0 && isEdited) {
			text = " ";
		}
		return text;
	}
