 ...
 * @generated
 */
public class TransitionEffectEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ImaginDataVisualIDRegistry
						.getType(imagindata.diagram.edit.parts.TransitionEffectEditPart.VISUAL_ID),
				new Point(0, 80));
	}
	 ...
	 * @generated 
	 */
	public TransitionEffectEditPart(View view) {
		super(view);
	}
