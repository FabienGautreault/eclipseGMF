...
import imagindata.diagram.edit.policies.InitExitGraphicalNodeEditPolicy;
import imagindata.diagram.edit.policies.InitExitItemSemanticEditPolicy;
import imagindata.diagram.part.ImaginDataDiagramEditorPlugin;
import imagindata.diagram.part.ImaginDataDiagramUpdateCommand;
import imagindata.diagram.part.ImaginDataVisualIDRegistry;
import imagindata.diagram.providers.ImaginDataElementTypes;
import imagindata.presentation.imagindataEditor;
 ...
 * @generated
 */
public class InitExitEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public InitExitEditPart(View view) {
		super(view);
		myView = view;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InitExitItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		InitExit test = (InitExit) ((Node) InitExitEditPart.this.getModel())
		.getElement();
		URL url = null;
		if (test.getType().getLiteral().equals("Init")) {
			url = FileLocator.find(Activator.getInstance().getBundle(),
					new Path("SVGImages/Entry.svg"), null); //$NON-NLS-1$
		} else if (test.getType().getLiteral().equals("Exit")) {
			url = FileLocator.find(Activator.getInstance().getBundle(),
					new Path("SVGImages/Exit.svg"), null); //$NON-NLS-1$
		}
	...
	protected void handleNotificationEvent(Notification notification) {
		if (notification.getNotifier() instanceof InitExit) {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof imagindata.diagram.edit.parts.InitExitEditPart) {
			types.add(ImaginDataElementTypes.Transition_4001);
		}
	...
	public List getRelTypesForSREOnSource(IElementType relationshipType){
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		return types;
	}
