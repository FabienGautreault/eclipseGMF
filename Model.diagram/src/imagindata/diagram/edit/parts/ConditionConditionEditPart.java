...
import org.eclipse.gmf.runtime.lite.edit.parts.labels.CompositeLabelTextDisplayer;
 ...
 * @generated
 */
public class ConditionConditionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ImaginDataParserProvider
					.getParser(
							ImaginDataElementTypes.Condition_3007,
							getParserElement(),
							ImaginDataVisualIDRegistry
									.getType(imagindata.diagram.edit.parts.ConditionConditionEditPart.VISUAL_ID));
		}
		return parser;
	}
