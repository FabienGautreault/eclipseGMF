 ...
 * @generated
 */
public class AnchorEditPart extends AbstractBorderItemEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AnchorItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		Anchor test = (Anchor) ((Node) AnchorEditPart.this.getModel())
				.getElement();
		URL url = null;
		if (test.getType().getLiteral().equals("Entry")) {
			url = FileLocator.find(Activator.getInstance().getBundle(),
					new Path("SVGImages/EntryPort.svg"), null); //$NON-NLS-1$
		} else if (test.getType().getLiteral().equals("Exit")) {
			url = FileLocator.find(Activator.getInstance().getBundle(),
					new Path("SVGImages/ExitPort.svg"), null); //$NON-NLS-1$
		}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof imagindata.diagram.edit.parts.AnchorEditPart) {
			types.add(ImaginDataElementTypes.Transition_4001);
		}
